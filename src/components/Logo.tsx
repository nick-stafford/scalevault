/**
 * Scalevault Financial mark — a silver coin / medallion: brushed-silver rim with a
 * reeded (ridged) edge, a black face, and a silver "SVF" in the center, with a
 * sun-glint sparkle. Self-contained SVG.
 */
export default function Logo({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} role="img" aria-label="Scalevault Financial">
      <defs>
